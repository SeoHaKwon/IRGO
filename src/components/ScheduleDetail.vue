    ...
    <div class="datail-inner">
      ...
      <div class="detail-cont">
        <ul class="list">
          <li>
            ...
            <p class="time en">2019.10.18 ~19 <span class="en">10:00 ~ 11:00</span></p>
          </li>
          <li>
            <strong class="tit">장소</strong>
            <p>본사 사무실, 경기도 수원시 영통구 삼성로 129 (매탄동)</p>
          </li>
          <li>
      ...
      <div class="list-btn">
        ...
        <div class="link-box next">
          <span>다음글</span>
          <p>두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트두줄테스트</p>
          <a href="#" class="link"></a>
        </div>
      </div>
